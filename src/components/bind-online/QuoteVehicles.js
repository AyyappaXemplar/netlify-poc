    ...
    <Container>
      ...
      <Row className="justify-content-center">
        <Col lg={6}>
          ...
          <span className="d-block">If you'd like to add additional vehicles, you'll need to go back to add<br className="d-sm-none"/>and re-rate your original quote.</span>
