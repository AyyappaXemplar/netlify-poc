...
export default function PolicyCoverages() {
  ...
  return (
    <>
      ...
      <Container
        className={"bg-white shadow rounded col-xs-12 col-md-6 mb-5"}
      ...
      >
        ...
        <div className="d-flex flex-row align-items-center coverage-note">
          ...
          <div>
            Full coverage offers both coverage for the people and property you
            hurt or damage – along with you or your vehicle.
          </div>
        </div>
      </Container>
    </>
