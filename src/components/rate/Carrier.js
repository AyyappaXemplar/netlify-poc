  ...
  return (
    <>
      ...
      <p className="text-med-dark mb-0">
        ...
        <br />
        <span className="d-flex mt-2">{t("customerService")}: &nbsp;<a href={`tel:${carrier.phone}`} className="text-dark"><u className="text-primary">{formatPhoneNumber(carrier.phone)}</u></a></span>
