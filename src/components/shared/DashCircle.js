...
export default function DashCircle({circleFill = 'white', rectFill = 'var(--danger'}) {
  return (
    <svg width="22px"  height="22px" viewBox="0 0 22 22" version="1.1" xmlns="https://www.w3.org/2000/svg">
