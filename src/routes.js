...
const routes = [
  ...
  { path:'/quotes/new',    main: (props) => <QuotesNew   {...props} />, showProgress: true },
  { path:'/quotes/edit',   main: (props) => <QuotesEdit  {...props} />, showProgress: true },
  { path:'/quotes/submit', main: (props) => <QuotesSubmit {...props} />, showProgress: true },
  { path:'/quotes/rated',  main: (props) => <RatedQuote   {...props} /> },
  { path:'/quotes/not-covered', main: (props) => <QuotesNotCovered  {...props} />, showProgress: true },
  { path:'/quotes/:resource(vehicles|drivers|discounts|review)', main: (props) => <Quotes {...props} /> },
  { path:'/vehicles/new',  main: (props) => <VehiclesNew {...props} />, showProgress: true },
  { path:'/vehicles/:vehicleId/edit', main: (props) => <VehiclesEdit      {...props} />, showProgress: true },
  { path:'/drivers/new',   main: (props) => <DriversNew   {...props} />,          showProgress: true },
  { path:'/drivers/:driverId/edit' , main: (props) => <DriversEdit {...props} />, showProgress: true },
