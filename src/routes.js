...
const routes = [
  ...
  {
    path: "/quotes/not-covered",
    main: (props) => <QuotesNotCovered {...props} />,
  },
  { path: "/quotes/:quoteId/rates", main: (props) => <Rate {...props} /> },
  {
    path: "/quotes/:resource(vehicles|drivers|review)",
    main: (props) => <Quotes {...props} />,
  },
  { path: "/vehicles/new", main: (props) => <VehiclesNew {...props} /> },
  {
    path: "/vehicles/:vehicleId/edit-coverages",
    main: (props) => <VehiclesCoverages {...props} />,
  },
  {
    path: ["/vehicles/:vehicleId/edit", "/rates/vehicles/:vehicleId/edit"],
    main: (props) => <VehiclesEdit {...props} />,
  },
  { path: "/drivers/new", main: (props) => <DriversNew {...props} /> },
  {
    path: ["/drivers/:driverId/edit", "/rates/drivers/:driverId/edit"],
    main: (props) => <DriversEdit {...props} />,
  },
  {
    path: "/rates/:quoteId/compare",
