...
export const policyCoverageTypes = ['bodily_injury', 'property_damage',
                             'uninsured_motorist_bodily_injury', 'uninsured_motorist_property_damage', 'other_than_collision',
...
export const policyCoverageTypeDescriptions = ['Bodily Injury', 'Property Damage',
                             'Uninsured Motorist BI',"Uninsured Motorist PD","Other Than Collision",
